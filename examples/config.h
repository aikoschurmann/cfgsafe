...
void DatabaseConfig_print(const DatabaseConfig_t *cfg, FILE *f) {
    if (!cfg) return;
    if (!f) f = stdout;
    fprintf(f, "--- DatabaseConfig Configuration ---\n");
    fprintf(f, "%*sdriver = ", 0, "");
    fprintf(f, "%d (enum)\n", (int)cfg->driver);
    fprintf(f, "%*shost = ", 0, "");
    fprintf(f, "\"%s\"\n", cfg->host ? cfg->host : "null");
    fprintf(f, "%*spassword = ", 0, "");
    fprintf(f, "********\n");
    fprintf(f, "%*sport = ", 0, "");
    fprintf(f, "%lld\n", (long long)cfg->port);
    fprintf(f, "%*spool_size = ", 0, "");
    fprintf(f, "%lld\n", (long long)cfg->pool_size);
    fprintf(f, "--------------------------\n");
}
...
void AuthConfig_print(const AuthConfig_t *cfg, FILE *f) {
    if (!cfg) return;
    if (!f) f = stdout;
    fprintf(f, "--- AuthConfig Configuration ---\n");
    fprintf(f, "%*senabled = ", 0, "");
    fprintf(f, "%s\n", cfg->enabled ? "true" : "false");
    fprintf(f, "%*sprovider = ", 0, "");
    fprintf(f, "%d (enum)\n", (int)cfg->provider);
    fprintf(f, "%*stoken_ttl = ", 0, "");
    fprintf(f, "%lld\n", (long long)cfg->token_ttl);
    fprintf(f, "--------------------------\n");
}
...
void ApiGateway_print(const ApiGateway_t *cfg, FILE *f) {
    if (!cfg) return;
    if (!f) f = stdout;
    fprintf(f, "--- ApiGateway Configuration ---\n");
    fprintf(f, "%*sservice_name = ", 0, "");
    fprintf(f, "\"%s\"\n", cfg->service_name ? cfg->service_name : "null");
    fprintf(f, "%*sbind_address = ", 0, "");
    fprintf(f, "%u.%u.%u.%u\n", cfg->bind_address.octets[0], cfg->bind_address.octets[1], cfg->bind_address.octets[2], cfg->bind_address.octets[3]);
    fprintf(f, "%*slisten_port = ", 0, "");
    fprintf(f, "%lld\n", (long long)cfg->listen_port);
    fprintf(f, "%*senable_tls = ", 0, "");
    fprintf(f, "%s\n", cfg->enable_tls ? "true" : "false");
    fprintf(f, "%*scert_path = ", 0, "");
    fprintf(f, "\"%s\"\n", cfg->cert_path ? cfg->cert_path : "null");
    fprintf(f, "%*sdatabase = ", 0, "");
    fprintf(f, "{\n");
    fprintf(f, "%*sdriver = ", 2, "");
    fprintf(f, "%d (enum)\n", (int)cfg->database.driver);
    fprintf(f, "%*shost = ", 2, "");
    fprintf(f, "\"%s\"\n", cfg->database.host ? cfg->database.host : "null");
    fprintf(f, "%*spassword = ", 2, "");
    fprintf(f, "********\n");
    fprintf(f, "%*sport = ", 2, "");
    fprintf(f, "%lld\n", (long long)cfg->database.port);
    fprintf(f, "%*spool_size = ", 2, "");
    fprintf(f, "%lld\n", (long long)cfg->database.pool_size);
    fprintf(f, "%*s}\n", 0, "");
    fprintf(f, "%*sauth = ", 0, "");
    fprintf(f, "{\n");
    fprintf(f, "%*senabled = ", 2, "");
    fprintf(f, "%s\n", cfg->auth.enabled ? "true" : "false");
    fprintf(f, "%*sprovider = ", 2, "");
    fprintf(f, "%d (enum)\n", (int)cfg->auth.provider);
    fprintf(f, "%*stoken_ttl = ", 2, "");
    fprintf(f, "%lld\n", (long long)cfg->auth.token_ttl);
    fprintf(f, "%*s}\n", 0, "");
    fprintf(f, "%*s[logging]\n", 0, "");
    fprintf(f, "%*slevel = ", 2, "");
    fprintf(f, "%d (enum)\n", (int)cfg->logging.level);
    fprintf(f, "%*sfile_path = ", 2, "");
    fprintf(f, "\"%s\"\n", cfg->logging.file_path ? cfg->logging.file_path : "null");
    fprintf(f, "%*smax_backups = ", 2, "");
    fprintf(f, "%lld\n", (long long)cfg->logging.max_backups);
    fprintf(f, "%*s[caching]\n", 0, "");
    fprintf(f, "%*senabled = ", 2, "");
    fprintf(f, "%s\n", cfg->caching.enabled ? "true" : "false");
    fprintf(f, "%*snodes = ", 2, "");
    fprintf(f, "[ ");
    for (size_t i = 0; i < cfg->caching.nodes.count; i++) fprintf(f, "%s%s", i > 0 ? ", " : "", ((const char**)cfg->caching.nodes.data)[i]);
    fprintf(f, " ]\n");
    fprintf(f, "%*sttl = ", 2, "");
    fprintf(f, "%lld\n", (long long)cfg->caching.ttl);
    fprintf(f, "--------------------------\n");
}
...
cfg_status_t ApiGateway_load(ApiGateway_t *cfg, const char *filename, cfg_error_t *err) {
    ...
    cfg->database.driver = DatabaseConfig_driver_postgres;
    cfg->database.host = cfg_intern_string(&ctx, "localhost");
    cfg->database.port = 5432;
    cfg->database.pool_size = 10;
    cfg->auth.enabled = true;
    cfg->auth.provider = AuthConfig_provider_jwt;
    cfg->auth.token_ttl = 3600;
